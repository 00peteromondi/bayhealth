...
urlpatterns = [
    ...
    path("patients/<int:patient_id>/allergies/create/", views.create_allergy, name="create_allergy"),
    path("patients/<int:patient_id>/immunizations/create/", views.create_immunization, name="create_immunization"),
    path("patients/<int:patient_id>/chronic-conditions/create/", views.create_chronic_condition, name="create_chronic_condition"),
    path("patients/<int:patient_id>/family-history/create/", views.create_family_history, name="create_family_history"),
    path("patients/<int:patient_id>/surgical-history/create/", views.create_surgical_history, name="create_surgical_history"),
    path("patients/<int:patient_id>/consents/create/", views.create_consent_form_record, name="create_consent_form_record"),
    path("patients/<int:patient_id>/documents/create/", views.create_patient_document, name="create_patient_document"),
    path("patients/<int:patient_id>/images/create/", views.create_medical_image, name="create_medical_image"),
    ...
    path("invitations/<int:invitation_id>/manage/", views.manage_invitation, name="manage_invitation"),
]
